          ...
          <div class="mt-4">
            ...
            <div>
              <Select
                ...
                label-overide-class="block text-sm text-left font-medium text-custom-primary"
            ...
            <div class="relative rounded-md shadow-sm mt-4">
              <label
                for="phoneNumber"
                :class="[
                  'block text-sm text-left font-medium text-custom-primary',
                ]"
                >Phone Number</label
              >
              <input
...
export default {
  ...
  methods: {
    ...
    async sendAirtime() {
      const params = {
        network: this.serviceType,
        telephone: this.phoneNumber.replaceAll(' ', ''),
